...
int main()
{
	...
	//SORTED INTERSECT
	////////////////////////////
	printf("Intersect of two sorted lists: ");
	List SortedIntersect1 = NULL;
	Push(&SortedIntersect1, 7);
	Push(&SortedIntersect1, 6);
	Push(&SortedIntersect1, 5);
	Push(&SortedIntersect1, 4);
	Push(&SortedIntersect1, 3);
	Push(&SortedIntersect1, 2);
	Push(&SortedIntersect1, 1);
	List SortedIntersect2 = NULL;
	Push(&SortedIntersect2, 70);
	Push(&SortedIntersect2, 60);
	Push(&SortedIntersect2, 7);
	Push(&SortedIntersect2, 6);
	Push(&SortedIntersect2, 5);
	Push(&SortedIntersect2, 3);
	Push(&SortedIntersect2, 2);
	List SortedIntersect3 = SortedIntersect(SortedIntersect1, SortedIntersect2);
	while (SortedIntersect3 != NULL)
	{
		printf("%d  ", SortedIntersect3->data);
		SortedIntersect3 = SortedIntersect3->next;
	}
	printf("\n");
	printf("\n");
	////////////////////////
	...
	//RECURSIVE REVERSE
	//////////////////////////
	printf("Recursive Reverse list: ");
	List RecursiveReverse1 = NULL;
	Push(&RecursiveReverse1, 5);
	Push(&RecursiveReverse1, 4);
	Push(&RecursiveReverse1, 3);
	Push(&RecursiveReverse1, 2);
	Push(&RecursiveReverse1, 1);
	RecursiveReverse(&RecursiveReverse1);
	while (RecursiveReverse1 != NULL)
	{
		printf("%d  ", RecursiveReverse1->data);
		RecursiveReverse1 = RecursiveReverse1->next;
	}
	printf("\n");
	printf("\n");
}
